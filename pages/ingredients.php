    ...
    <table>
        ...
        <tr>
            ...
            <td>
                ...
                <input id='ingredientsInput<?php echo $row["IngredientID"]; ?>' class='all<?php echo $row["IngredientID"]; ?>' REQUIRED IngredientID='IngredientName_<?php echo $row["IngredientID"]; ?>' type='text' name='IngredientName' value='<?php echo $row["IngredientName"]; ?> ' disabled>
            </td>
            <td>
                <span>Quantity:</span>
