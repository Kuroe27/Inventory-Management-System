            ...
            <div class="container">
                <section class="header">
                    ...
                    <div class="boxes">
                        <div class="box">
                            <div class="smBox">
                                <img src="../icons/user.png" alt="dashboardIcon" class="box../icons">
                            </div>
                            <h3>Total User</h3>
                        ...
                        <div class="box">
                            <div class="smBox">
                                <img src="../icons/Ingredients.png" alt="dashboardIcon" class="box../icons">
                            </div>
                            <h3>Ingredients</h3>
                        ...
                        <div class="box">
                            <div class="smBox">
                                <img src="../icons/menu.png" alt="dashboardIcon" class="box../icons">
                            </div>
                            <h3>Menu Items</h3>
                        ...
                        <div class="box">
                            <div class="white">
                                <img src="../icons/restock.png" alt="dashboardIcon" class="box../icons">
                            </div>
